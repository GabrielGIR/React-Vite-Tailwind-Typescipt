        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex item-center gap-3">
              <img src={logo} alt="Joyas Logo" className="w-10 h-10" />
          ...
          <div
            className="flex flex-col lg:flex-row w-full lg:justify-between 
                lg:items-center absolute top-full left-0 lg:static lg:top-0 bg-body lg:bg-transparent border-x border-x-box-border lg:border-x-0 lg:h-auto"
          >
            ...
            <div className="lg:min-w-max flex items-center sm:w-max w-full pb-6 lg-pb-0 border-b border-box-border lg:border-0 px-6 lg:px-0">
              <BtnLink text="Get started" href="#cta" className="" bd-body />
            </div>
          </div>
        </nav>
      </Container>
